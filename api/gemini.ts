...
async function handleGenerateBusinessNames(
  res: VercelResponse,
  params: { niche: string }
) {
  const { niche } = params;
...
async function handleGenerateLogo(
  res: VercelResponse,
  params: { brandName: string; niche: string }
) {
...
async function handleGenerateAdConcepts(
  res: VercelResponse,
  params: { brandProfile: any }
) {
...
// Generate Ad Visual (composite description)
async function handleGenerateAdVisual(
  res: VercelResponse,
  params: {
    brandName: string;
...
async function handleGenerateTargetingSuggestions(
  res: VercelResponse,
  params: { brandProfile: any; platform?: string }
) {
